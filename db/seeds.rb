...
order1 = Order.create({user: user1, send_to_address: "千葉", deliver_date: Date.current + 1.day,
                       deliver_time_range: "16-18"})
...
order2_product1 = OrderProduct.create( { order: order1, product: product2, quantity: 3})
